	    	...
	    	<div class="container marketing">
		        ...
		        <div class="row">
	        		<div class="col-lg-4">
				        ...
				        <h2>Buffet</h2>
				        <p>Crie tarefas, como o buffet, por exemplo, descreva-as, estabeleça prazos e, se necessário, relacione aos serviços. Quanto ao mais, nem se preocupe: Tudo estará bem organizado.</p>
			        ...
			        <div class="col-lg-4">
				        ...
				        <h2>Convites</h2>
				        <p>Gerencie sua lista de convidados, envie links para os mesmos se cadastrarem e confirmarem presença na sua cerimônia.</p>
				        <p><a class="btn btn-secondary" href="#" role="button">Ver mais &raquo;</a></p>
			        </div><!-- /.col-lg-4 -->
		          	<div class="col-lg-4">
		            	<img class="rounded-circle" src=" <c:url value="/images/servico3.jpg"/> " alt="Generic placeholder image" width="140" height="140">
		            	<h2>Decoração</h2>
		            	<p>Na hora de contratar serviços de profissionais, como a decoração, não se preocupe. O WeddingWeb permique que você vincule suas tarefas aos diversos serviços disponibilizados por profissionais, contrate serviços e fique por dentro do que está acontecendo. Quanto ao orçamento, gerenciamos tudo pra você.</p>
		            	<p><a class="btn btn-secondary" href="#" role="button">Ver mais  &raquo;</a></p>
		        	</div><!-- /.col-lg-4 -->
	        	</div><!-- /.row -->
		        ...
		        <div class="row featurette">
			        <div class="col-md-7">
				        ...
				        <p class="lead">Crie tarefas, descreva-as, estabeleça prazos e, se necessário, relacione aos serviços. Quanto ao mais, nem se preocupe: Tudo estará bem organizado.</p>
			        </div>
			        <div class="col-md-5">
		        ...
		        <div class="row featurette">
				    <div class="col-md-7 order-md-2">
				    	...
				    	<p class="lead">Gerencie sua lista de convidados, envie links para os mesmos se cadastrarem e confirmarem presença na sua cerimônia de maneira bem simples, sem complicação.</p>
				    </div>
	        	...
	        	<div class="row featurette">
	            	<div class="col-md-7">
	            		<h2 class="featurette-heading">E os serviços?<span class="text-muted">e os profissionais?</span></h2>
	            		<p class="lead">Na hora de contratar serviços para sua cerimônia, o WeddingWeb permique que você vincule suas tarefas aos diversos serviços disponibilizados por profissionais, contrate serviços e fique por dentro do que está acontecendo, incluindo o orçamento, gerenciamos tudo pra você.</p>
	          		</div>
	          		<div class="col-md-5">
